...
java -cp .:../aspectjrt.jar:../aspectjtools.jar org.aspectj.tools.ajc.Main -source 1.8 -target 1.8 \
	de/uni_luebeck/isp/rvwithunionfind/benchmarks/benchmark3/InstrumentationAspect.aj \
